    ...
    try:
        ...
        await b.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("FOLLOW ME", url="https://GITHUB.COM/adarsh-goel")
                    ]
                ]
            ),
            disable_web_page_preview=True
...
async def list(l, m):
    ...
    await l.send_message(chat_id=m.chat.id, text=LIST_MSG.format(m.from_user.mention(style="md")))
